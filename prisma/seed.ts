...
async function main() {
  ...
  // ─── People ─────────────────────────────────────────────────────────────────
  // Note: IDs are set explicitly so casting references match the xlsx
  ...
  console.log('\n🎉 Seed complete!')
  console.log('   People not yet in castings (Steve Burns, Steve Ditko, Steve Guttenberg, Steve Jobs)')
  console.log('   → These are real Steves with no casting records yet — add characters/titles as you expand the data')
}
