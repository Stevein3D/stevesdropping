        ...
        <div className="space-y-3">
          ...
          {matched.length > 0 && (
            <div className="space-y-1">
              <p className="text-xs text-warm-600 dark:text-warm-500 uppercase tracking-wide">
                ...
                {matched.map((item, i) => (
                  ...
                  >
                    ...
                    <span className={
                      ...
                      : item.status === 'uploading' ? 'text-warm-600 dark:text-warm-500 animate-pulse'
                      : 'text-warm-400'
                    }>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={reset}
              disabled={uploading}
              className="text-xs text-warm-600 dark:text-warm-500 hover:text-steve transition-colors disabled:opacity-40"
            >
              Clear
            </button>
          </div>
