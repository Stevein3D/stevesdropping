    ...
    <div className="space-y-8">
      ...
      <div className="grid sm:grid-cols-2 gap-4 max-w-xl">
        ...
        >
          ...
          <p className="text-sm text-warm-600">Upload an XLSX to sync people, characters, titles, episodes, and castings</p>
        </Link>
        <Link
          href="/admin/images"
          className="bg-cream-card dark:bg-warm-50/5 border border-cream-subtle dark:border-warm-700 rounded-lg p-5 hover:border-steve dark:hover:border-warm-200 transition-colors"
        >
          ...
          <p className="text-sm text-warm-600">Upload and manage images for people, characters, titles, and castings</p>
        </Link>
      </div>
    </div>
  )
